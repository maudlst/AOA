_report = {
  metrics = {
    ...
    compilation_flags = "measure: GNU C17 11.3.0 -mtune=generic -march=x86-64 -g -O2 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection\n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 94.05,
    speedup_if_fp_vect = 1.345,
    ...
    speedup_if_fully_vectorised = 2.4688,
    ...
    nb_threads = 1,
    application_time = 1.3743450641632,
    compilation_options = 50,
    innerloops_time = 94.05,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.27 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 269 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.27 seconds.",
  },
  colors = {
  ...
  comp_opt_report = {
    ["measure#kernel.c"] = {
      opts = "GNU C17 11.3.0 -mtune=generic -march=x86-64 -g -O2 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection",
      score = "0.5",
      issues = {"-march=(target) is missing. ", "-funroll-loops is missing. ", },
    },
  },
}
