_report = {
  metrics = {
    ...
    compilation_flags = "measure: AMD clang version 14.0.6 (CLANG: AOCC_4.0.0-Build#434 2022_10_28) (based on LLVM Mirror.Version.14.0.6)\n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 96.96,
    speedup_if_fp_vect = 1.2565,
    ...
    speedup_if_fully_vectorised = 1.9853,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.019,
    profiled_time = 5.09,
    array_access_efficiency = 100,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.019,
    nb_threads = 1,
    application_time = 5.2198891639709,
    compilation_options = 50,
    innerloops_time = 96.96,
  },
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.94 seconds.",
  },
  colors = {
  ...
  comp_opt_report = {
    ["measure#kernel.c"] = {
      opts = "AMD clang version 14.0.6 (CLANG: AOCC_4.0.0-Build#434 2022_10_28) (based on LLVM Mirror.Version.14.0.6)",
      score = "0.5",
      issues = {"-O2, -O3 or -Ofast is missing. ", "-x(target) or -ax(target) is missing. ", },
    },
  },
}
